							...
							<?php echo $message;?>
								<form action="<?php echo base_url('status/edit/').$id ?>" method="post" autocomplete="off" class="form form-horizontal">
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<textarea name="description" id="description" class="form-control" rows="4" style="resize:vertical; min-height:100px; max-height:200px;"><?php echo $curr_description ?></textarea>
										</div>
									</div>
									<div class="form-group">
