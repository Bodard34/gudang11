            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        <li style="padding-top: 10px; padding-left: 14px; color: grey;">MAIN NAVIGATION</li>
                        <li>
                    ...
                    <?php if ($this->ion_auth->logged_in()): ?>
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                              <li><a href="<?php echo base_url('inventory/index') ?>"><i class="fa fa-plus"></i> Add New</a></li>
                              ...
                              <li><a href="<?php echo base_url('inventory/by_location') ?>"><i class="fa fa-map-marker"></i> By Location</a></li>
                              <li><a href="<?php echo base_url('inventory/search') ?>"><i class="fa fa-search"></i> Search</a></li>
                            </ul>
                        </li>
                        <li style="padding-top: 10px; padding-left: 14px; color: grey;">MASTER
                        </li>
                        <li>
                        ...
                        <?php if ($this->ion_auth->is_admin()): ?>
                            ...
                            <!-- Menu Admin -->
                            <li style="padding-top: 10px; padding-left: 14px; color: grey;">SETTINGS
                            </li>
                            <li>
                        ...
                        <?php endif ?>
                        <li style="padding-top: 10px; padding-left: 14px; color: grey;">OPTIONS
                        </li>
                        <li>
