...
<!-- iCheck -->
	<link rel="stylesheet" href="<?php echo base_url('assets/templates/AdminLTE/plugins/iCheck/square/square.css'); ?>">
	<script src="<?php echo base_url('assets/templates/AdminLTE/plugins/iCheck/icheck.min.js'); ?>"></script>
...
<!-- Select2 -->
	<link rel="stylesheet" href="<?php echo base_url('assets/templates/AdminLTE/plugins/select2/select2.min.css'); ?>">
	<style media="screen">
		.select2-container .select2-selection--single{
			height: auto;
		}
	</style>
	<script type="text/javascript" src="<?php echo base_url('assets/templates/AdminLTE/plugins/select2/select2.full.min.js'); ?>"></script>
	<script type="text/javascript">
		$(".select2").select2();
	</script>
<!-- / Select2 -->
...
<!-- Chartjs -->
	<script type="text/javascript" src="<?php echo base_url('assets/templates/AdminLTE/plugins/chartjs/Chart.bundle.min.js'); ?>"></script>
