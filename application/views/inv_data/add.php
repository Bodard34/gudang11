...
<aside class="right-side">
  ...
  <section class="content">
        ...
        <?php echo $message;?>
					<form id="input_form" action="<?php base_url('inventory/index')?>" method="post" autocomplete="off" class="form form-horizontal" enctype="multipart/form-data">
							<h3>Basic Info</h3>
							<fieldset>
							...
							<fieldset>
								...
								<div class="form-group">
									<label for="qty" class="control-label col-md-2">Qty</label>
									<div class="col-md-4">
										<div class="input-group">
											<input type="number" name="qty" id="qty" class="form-control" maxlength="12" min="0" value="<?php echo set_value('qty') ?>">
