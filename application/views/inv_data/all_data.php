		...
		<section class="content">
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					...
					<a href="<?php echo base_url('inventory/index'); ?>" class="btn btn-primary" role="button"><i class="fa fa-plus"></i>
					<span> New data</span></a>
         			<a href="<?php echo base_url('export/export');?>" class="btn btn-success" role="button"><i class="fa fa-file"></i>
         			<span> Export</span></a>
         			</h3>
				</div>
				<div class="box-body">
									...
									<td width="15%">
										<form action="<?php echo base_url('inventory/delete/'.$data->id) ?>" method="post" autocomplete="off">
											<div class="btn-group-vertical">
												<a class="btn btn-sm btn-default" href="<?php echo base_url('inventory/detail/'.$data->code) ?>" role="button"><i class="fa fa-eye"></i><span> Detail</span></a>
												<a class="btn btn-sm btn-primary" href="<?php echo base_url('inventory/edit/'.$data->code) ?>" role="button"><i class="fa fa-pencil"></i><span> Edit</span></a>
												<input type="hidden" name="id" value="<?php echo $data->id; ?>">
												<button type="submit" class="btn btn-sm btn-danger" role="button" onclick="return confirm('Delete this data?')"><i class="fa fa-trash"></i><span> Delete</span></button>
											</div>
										</form>
									</td>
								</tr>
