					...
					<form id="input_form" action="<?php echo base_url('inventory/edit/').$code ?>" method="post" autocomplete="off" class="form form-horizontal" enctype="multipart/form-data">
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<input type="text" name="model" id="model" class="form-control <?php if (form_error('model')) { echo "error"; } ?>" value="<?php echo $curr_model ?>">
									</div>
								</div>
								<div class="form-group">
									<label for="serial_number" class="control-label col-md-2">Serial Number</label>
									<div class="col-md-8">
										<input type="text" name="serial_number" id="serial_number" class="form-control <?php if (form_error('serial_number')) { echo "error"; } ?>" value="<?php echo $curr_serial_number ?>">
									</div>
								</div>
								<hr>
								<div class="form-group">
                        ...
                        $selected = ($curr_location_id == $lls->id) ? "selected" : "";
								...
								<div class="form-group">
									<p class="col-md-8 col-md-offset-2">(*) Harus Diisi</p>
								</div>
							</fieldset>
                          ...
                          $selected = ($curr_color == $crl->name) ? "selected" : "";
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<div class="input-group">
											<input type="number" name="qty" id="qty" class="form-control" maxlength="12" min="0" value="<?php echo $curr_qty ?>">
								...
								<div class="form-group">
									...
									<div class="col-md-10">
                    					<?php if ($curr_thumbnail!=""): ?>
                    						<img src="<?php echo base_url("assets/uploads/images/inventory/").$curr_thumbnail; ?>" alt="Current Photo">
                    					<?php endif; ?>
