						...
						if ($this->input->post('user_photo')) {
							if (!empty($_FILES['user_photo']['name'])) {
								...
								// upload success, get path and filename
									...
									// save to database
									$datas['user_photo']     = $link_foto;
									$this->profile_model->update_user_photo($this->input->post('id'), $datas);

									// delete old Photo (if needed)
									if ($this->input->post('user_photo')!="") {
									unlink("assets/uploads/images/profile/".$this->input->post('user_photo'));
									}
								}
							}
						}
