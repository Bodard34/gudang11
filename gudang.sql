...
MySQL - 5.5.5-10.1.30-MariaDB : Database - gudang_database
*********************************************************************
*/
...
CREATE TABLE `inv_datas` (
  ...
  `qty` int(12) DEFAULT NULL COMMENT 'Stok',
...
insert  into `inv_status`(`id`,`name`,`description`,`created_by`,`created_on`,`updated_by`,`updated_on`) values (1,'In Use','<p>Aktif digunakan</p>','administrator','2018-04-13 11:16:07','administrator','2018-04-13 11:16:07'),(2,'Not Used','<p>Tidak digunakan</p>','administrator','2018-04-13 11:17:25','administrator','2018-04-13 11:17:25'),(3,'In Repair','<p>Status barang masih dalam perbaikan</p>','administrator','2018-04-18 16:34:43','administrator','2018-04-18 16:35:05');
...
insert  into `master_color`(`id`,`name`,`created_by`,`created_on`,`updated_by`,`updated_on`) values (1,'Black','administrator','2018-04-03 16:30:13','administrator','2018-04-03 16:30:13'),(2,'White','administrator','2018-04-13 10:48:13','administrator','2018-04-13 10:48:13'),(3,'Grey','administrator','2018-04-13 11:32:37','administrator','2018-04-18 15:38:32'),(4,'Blue','administrator','2018-04-13 11:32:44','administrator','2018-04-18 15:38:24'),(5,'Red','administrator','2018-04-18 15:37:57','administrator','2018-04-18 15:37:57'),(6,'Brown','administrator','2018-05-09 10:56:40','administrator','2018-05-09 10:56:40'),(7,'Yellow','administrator','2018-05-09 11:02:17','administrator','2018-05-09 11:02:17'),(8,'Black White','administrator','2018-05-11 09:43:40','administrator','2018-05-11 09:43:40'),(9,'Green','administrator','2018-05-18 15:13:17','administrator','2018-05-18 15:13:17');
...
CREATE TABLE `users` (
  ...
  `user_photo` varchar(100) NOT NULL DEFAULT 'no_picture.png',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

/*Data for the table `users` */

insert  into `users`(`id`,`ip_address`,`username`,`password`,`salt`,`email`,`activation_code`,`forgotten_password_code`,`forgotten_password_time`,`remember_code`,`created_on`,`last_login`,`active`,`first_name`,`last_name`,`phone`,`user_photo`) values (1,'127.0.0.1','administrator','$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36','','admin@admin.com','',NULL,NULL,'gGSTNbCuCI/8jRvE.dfQZ.',1268889823,1527123844,1,'System','Administrator','01234567','no_picture.png');
